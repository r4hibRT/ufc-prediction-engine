@echo off
REM Development mode: API on :8000 with reload, Vite on :5173 with hot reload.
...
start "UFC API" cmd /k "cd /d "%ROOT%" && set PYTHONPATH=%ROOT% && "%UFC_PYTHON%" -m uvicorn src.api.main:app --port 8000 --reload"
